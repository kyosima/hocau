                ...
                onPressed: () {
                  ...
                  showDialog(
                      ...
                      builder: (BuildContext context) {
                        return MoneyAlert('Yêu cầu rút tiền thành công',
                            'Bạn vừa thực hiện thành công yêu cầu rút tiền về ngân hàng thụ hưởng. Hệ thống sẽ xử lý trong vòng 24h.');
                      });
                },
                child: CustomText(
